...
4. **Confirm completion:**
   - Display: "Session summaries created for: ISSUE-N, ISSUE-M"
...
4. Implement fix
5. `/issue session ISSUE-N` - record the fix
6. If complete: `/issue done ISSUE-N`
...
6. `/issue done ISSUE-N` when feature complete
...
- **Making changes without an active issue** - Always have a ISSUE-N
