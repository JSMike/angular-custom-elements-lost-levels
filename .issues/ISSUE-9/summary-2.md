...
**Prompt/Ask:** Turn the select-multiple and calendar-picker placeholder slides into concrete issue slides after the demos were implemented.

## Completed
- Replaced the placeholder select-multiple slide with a confirmed repro slide grounded in the observed Angular/native JSON mismatch.
...
## Plan Coverage
- Completed the select-multiple repro slide.
- Completed the calendar-picker repro slide.
- Verified the deck still builds after replacing the placeholders.

## Files Changed
- `slides.md` - Replaced the planned select-multiple/calendar content with confirmed issue slides and updated the repro matrix.
...
- Confirmed the select-multiple slide now reflects:
